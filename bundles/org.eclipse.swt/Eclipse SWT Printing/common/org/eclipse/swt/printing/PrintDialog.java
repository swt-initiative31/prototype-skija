...
public class PrintDialog extends Dialog {
	...
	private final NativePrintDialog wrappedPrintDialog;
...
public PrintDialog (Shell parent) {
	this (new NativePrintDialog(Widget.checkNative(parent)));
}
...
public PrintDialog (Shell parent, int style) {
	this (new NativePrintDialog(Widget.checkNative(parent), style));
}

PrintDialog(NativePrintDialog nativePrintDialog) {
	super(nativePrintDialog);
	this.wrappedPrintDialog = nativePrintDialog;
}
...
public void setPrinterData(PrinterData data) {
	wrappedPrintDialog.setPrinterData(data);
}
...
public PrinterData getPrinterData() {
	return wrappedPrintDialog.getPrinterData();
}
 ...
 */
public int getScope() {
	return wrappedPrintDialog.getScope();
}
...
public void setScope(int scope) {
	wrappedPrintDialog.setScope(scope);
}
...
public int getStartPage() {
	return wrappedPrintDialog.getStartPage();
}
...
public void setStartPage(int startPage) {
	wrappedPrintDialog.setStartPage(startPage);
}
...
public int getEndPage() {
	return wrappedPrintDialog.getEndPage();
}
...
public void setEndPage(int endPage) {
	wrappedPrintDialog.setEndPage(endPage);
}
...
public boolean getPrintToFile() {
	return wrappedPrintDialog.getPrintToFile();
}
...
public void setPrintToFile(boolean printToFile) {
	wrappedPrintDialog.setPrintToFile(printToFile);
}
...
public PrinterData open() {
	return wrappedPrintDialog.open();
}
}
