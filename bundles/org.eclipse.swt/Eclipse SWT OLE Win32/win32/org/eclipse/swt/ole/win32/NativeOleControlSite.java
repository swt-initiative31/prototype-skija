 ...
 */
public abstract class NativeOleControlSite extends NativeOleClientSite
{
...
public Color getBackground () {
	...
	if (objIUnknown != null) {
		...
		OleAutomation oleObject= new OleAutomation(this.getWrapper());
...
@Override
public abstract OleControlSite getWrapper();
