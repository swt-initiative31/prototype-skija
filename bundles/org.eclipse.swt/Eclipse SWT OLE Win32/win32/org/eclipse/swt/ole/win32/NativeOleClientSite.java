 ...
 */
public abstract class NativeOleClientSite extends NativeComposite {
...
private void onPaint(Event e) {
	if (state == STATE_RUNNING || state == STATE_INPLACEACTIVE) {
		...
		COM.OleDraw(objIUnknown.getAddress(), aspect, ((NativeGC) e.gc.innerGC).handle, pArea);
		OS.GlobalFree(pArea);
	}
}
...
@Override
public abstract OleClientSite getWrapper();
