...
public class SnippetCDateTime1 {
...
//	CDateTime calendar = new CDateTime (shell, SWT.CALENDAR | SWT.CALENDAR_WEEKNUMBERS);
//	calendar.addSelectionListener (widgetSelectedAdapter(e -> System.out.println ("calendar date changed")));

	CDateTime calendarDropDown = new CDateTime (shell, SWT.DROP_DOWN | SWT.CALENDAR_WEEKNUMBERS);
