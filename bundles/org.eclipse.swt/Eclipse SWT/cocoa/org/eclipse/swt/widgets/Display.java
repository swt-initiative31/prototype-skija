...
public Shell getActiveShell () {
	...
	return shell != null ? shell.wrap() : null;
}
...
public Control getCursorControl () {
	...
	return nativeControl != null? nativeControl.wrap() : null;
}
...
public Menu getSystemMenu () {
	...
	if (appMenu == null) {
		...
		for (int j = 0; j < nsCount; j++) {
			...
			new MenuItem(new NativeMenuItem(appMenu, currMenuItem));
		}
	}
	return appMenu.wrap();
}
...
public TaskBar getSystemTaskBar () {
	checkDevice ();
	if (taskBar != null) return taskBar.wrap();
