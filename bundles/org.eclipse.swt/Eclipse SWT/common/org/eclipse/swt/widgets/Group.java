...
public class Group extends Composite {
	...
	private void drawGroup(GC gc) {
		...
		int width = size.x;
		int height = size.y;
		textExtentCache = (textExtentCache != null) ? textExtentCache : calculateTextExtent();
	...
	private Point calculateTextExtent() {
		textExtentCache = Drawing.getTextExtent(this, text, DRAW_FLAGS);
