...
public TabItem (TabFolder parent, int style) {
	this.wrappedTabItem = WidgetFactory.createTabItem(this, parent, style);
}
...
public TabItem (TabFolder parent, int style, int index) {
	this.wrappedTabItem = WidgetFactory.createTabItem(this, parent, style, index);
}
...
public Control getControl () {
	NativeControl control = wrappedTabItem.getControl();
