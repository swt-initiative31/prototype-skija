...
// ------------------------------------------------------------
	...
	private TreeItemsHandler itemsHandler = new TreeItemsHandler(this);
	...
	private void onDispose(Event event) {
		var columnsSet = new HashSet<TreeColumn>();
		var itemsSet = new HashSet<TreeItem>();
...
//		}
	...
	static int guessTextHeight(Tree Tree) {
		int textHeight = Tree.getFont().getFontData()[0].getHeight();
