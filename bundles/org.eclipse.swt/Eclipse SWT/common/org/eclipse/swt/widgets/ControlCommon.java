...
public static Control getNativeParentAndOffset(Control control, Point offset) {
...
protected void redraw(int x, int y, int width, int height) {
	...
	final Composite parent = (Composite) getNativeParentAndOffset((Control) this, offset);
