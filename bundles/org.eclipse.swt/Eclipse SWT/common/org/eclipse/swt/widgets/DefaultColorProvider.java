...
public class DefaultColorProvider implements ColorProvider {
	...
	public static ColorProvider createLightInstance() {
		...
		p.put(DefaultScaleRenderer.KEY_HANDLE_IDLE, selection);
		p.put(DefaultScaleRenderer.KEY_HANDLE_HOVER, black);
		p.put(DefaultScaleRenderer.KEY_HANDLE_DRAG, gray204);
		p.put(DefaultScaleRenderer.KEY_HANDLE_OUTLINE, gray160);
		p.put(DefaultScaleRenderer.KEY_NOTCH, gray160);
		p.put(DefaultScaleRenderer.KEY_DISABLED, disabled);
	...
	public static ColorProvider createDarkInstance() {
		...
		p.put(Button.KEY_TOGGLE, gray128);
		p.put(Button.KEY_SELECTION, selection);
		...
		p.put(DefaultScaleRenderer.KEY_HANDLE_IDLE, selection);
		p.put(DefaultScaleRenderer.KEY_HANDLE_HOVER, gray204);
		p.put(DefaultScaleRenderer.KEY_HANDLE_DRAG, gray128);
		p.put(DefaultScaleRenderer.KEY_HANDLE_OUTLINE, gray128);
		p.put(DefaultScaleRenderer.KEY_NOTCH, gray128);
		p.put(DefaultScaleRenderer.KEY_DISABLED, disabled);
