...
public final class DefaultColorProvider implements ColorProvider {
	...
	public static DefaultColorProvider createLightInstance() {
		...
		p.put(Text.COLOR_BACKGROUND, white);
		p.put(Text.COLOR_BACKGROUND_READONLY, gray192);
		p.put(Text.COLOR_FOREGROUND, foreground);
		p.put(Text.COLOR_SELECTION_BACKGROUND, hsb(baseHue, 0.2f, 1));
		p.put(Text.COLOR_SELECTION_FOREGROUND, foreground);
		p.put(Text.COLOR_BORDER, gray128);
		...
		p.put(Link.COLOR_BACKGROUND, background);
		...
		p.put(DefaultToolBarRenderer.COLOR_BACKGROUND, background);
		p.put(DefaultToolBarRenderer.COLOR_FOREGROUND, foreground);
	...
	public static DefaultColorProvider createDarkInstance() {
		...
		p.put(Text.COLOR_BACKGROUND, gray64);
		p.put(Text.COLOR_BACKGROUND_READONLY, background);
		p.put(Text.COLOR_FOREGROUND, foreground);
		p.put(Text.COLOR_SELECTION_BACKGROUND, selection);
		p.put(Text.COLOR_SELECTION_FOREGROUND, white);
		p.put(Text.COLOR_BORDER, gray128);
