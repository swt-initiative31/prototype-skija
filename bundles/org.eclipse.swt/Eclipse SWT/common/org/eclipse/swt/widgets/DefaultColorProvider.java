...
public class DefaultColorProvider implements ColorProvider {
	...
	public static DefaultColorProvider createLightInstance() {
		...
		p.put(Composite.COLOR_BACKGROUND, background);

		p.put(ControlRenderer.COLOR_DISABLED, gray160);

		p.put(CSimpleText.COLOR_BACKGROUND, white);
		p.put(CSimpleText.COLOR_BACKGROUND_READONLY, gray192);
		p.put(CSimpleText.COLOR_FOREGROUND, foreground);
		p.put(CSimpleText.COLOR_SELECTION_BACKGROUND, hsb(baseHue, 0.2f, 1));
		p.put(CSimpleText.COLOR_SELECTION_FOREGROUND, foreground);
		p.put(CSimpleText.COLOR_BORDER, gray128);
		...
		p.put(ButtonRenderer.COLOR_FOREGROUND, foreground);
		...
		p.put(ButtonRenderer.COLOR_PUSH, white);

		p.put(LabelRenderer.COLOR_BACKGROUND, background);
		p.put(LabelRenderer.COLOR_FOREGROUND, foreground);
		...
		p.put(Link.COLOR_LINK, hsb(baseHue, 1, 0.6f));
		p.put(Link.COLOR_FOREGROUND, foreground);
		...
		p.put(ToolBarRenderer.COLOR_BACKGROUND, background);
		p.put(ToolBarRenderer.COLOR_FOREGROUND, foreground);
		p.put(ToolBarRenderer.COLOR_SEPARATOR, gray160);
		p.put(ToolBarRenderer.COLOR_SHADOW_OUT, gray160);
		p.put(ToolBarRenderer.COLOR_HOVER_BACKGROUND, hsb(baseHue, 0.2f, 1));
		p.put(ToolBarRenderer.COLOR_HOVER_BORDER, hsb(baseHue, 0.3f, 1));
		p.put(ToolBarRenderer.COLOR_SELECTION_BACKGROUND, hsb(baseHue, 0.3f, 1));
		p.put(ToolBarRenderer.COLOR_SELECTION_BORDER, hsb(baseHue, 0.5f, 1));
	...
	public static DefaultColorProvider createDarkInstance() {
		...
		final DefaultColorProvider p = new DefaultColorProvider();
		p.put(Composite.COLOR_BACKGROUND, gray30);

		p.put(ControlRenderer.COLOR_DISABLED, gray160);

		p.put(CSimpleText.COLOR_BACKGROUND, gray64);
		p.put(CSimpleText.COLOR_BACKGROUND_READONLY, background);
		p.put(CSimpleText.COLOR_FOREGROUND, foreground);
		p.put(CSimpleText.COLOR_SELECTION_BACKGROUND, selection);
		p.put(CSimpleText.COLOR_SELECTION_FOREGROUND, white);
		p.put(CSimpleText.COLOR_BORDER, gray128);

		p.put(ButtonRenderer.COLOR_PUSH, gray64);
		...
		p.put(Link.COLOR_LINK, hsb(baseHue, 0.6f, 1));
		p.put(Link.COLOR_FOREGROUND, foreground);
		...
		p.put(ToolBarRenderer.COLOR_SEPARATOR, gray160);
		p.put(ToolBarRenderer.COLOR_SHADOW_OUT, gray160);
		p.put(ToolBarRenderer.COLOR_HOVER_BACKGROUND, gray80);
		p.put(ToolBarRenderer.COLOR_HOVER_BORDER, gray128);
		p.put(ToolBarRenderer.COLOR_SELECTION_BACKGROUND, gray128);
		p.put(ToolBarRenderer.COLOR_SELECTION_BORDER, gray160);
		return p;
	}
