...
public class DefaultSliderRenderer extends SliderRenderer {
	...
	static final String COLOR_TRACK_BACKGROUND = "slider.track.background";
	static final String COLOR_TRACK_BORDER = "slider.track.border";
	static final String COLOR_THUMB_BACKGROUND = "slider.thumb.background";
	static final String COLOR_THUMB_BORDER = "slider.thumb.border";
	static final String COLOR_THUMB_HOVER = "slider.thumb.hover";
	...
	protected void paint(GC gc, int width, int height) {
		...
		gc.setForeground(isEnabled() ? slider.getForeground() : getColor(COLOR_DISABLED));
