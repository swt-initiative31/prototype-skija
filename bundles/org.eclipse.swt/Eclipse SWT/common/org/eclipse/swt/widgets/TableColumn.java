...
public class TableColumn extends Item {
	...
	public void pack() {
		...
		// int headerWidth = (int) OS.SendMessage(hwnd, OS.LVM_GETSTRINGWIDTH,
		// 0,
		// buffer) + Table.HEADER_MARGIN;
		// if (OS.IsAppThemed())
	...
	public void setAlignment(int alignment) {
		...
		// /*
		// * Bug in Windows. When LVM_SETCOLUMN is used to change the alignment
		// of
		// * a column, the column is not redrawn to show the new alignment. The
		// * fix is to compute the visible rectangle for the column and redraw
		// it.
		// */
		// if (index != 0) {
		// parent.forceResize();
	...
	public void setText(String string) {
		...
		// * changed after the column has been created, the alignment must also
		// be
		// * reset or the text does not draw. The fix is to query and then set
		// the
		// * alignment.
		// */
		// long hwnd = parent.handle;
		...
		// long result = OS.SendMessage(hwnd, OS.LVM_SETCOLUMN, index,
		// lvColumn);
		// if (pszText != 0)
