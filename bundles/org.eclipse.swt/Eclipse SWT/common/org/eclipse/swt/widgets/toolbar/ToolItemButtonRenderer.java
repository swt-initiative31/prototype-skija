...
public class ToolItemButtonRenderer implements ToolItemRenderer {
	...
	public enum ColorType {
		BORDER_DOWN(0.4f, ToolBarRenderer.KEY_SELECTION_BORDER),
		BORDER_HOVER(0.2f, ToolBarRenderer.KEY_HOVER_BORDER),
		FILL_DOWN(0.2f, ToolBarRenderer.KEY_SELECTION_BACKGROUND),
		FILL_HOVER(0.1f, ToolBarRenderer.KEY_HOVER_BACKGROUND);
