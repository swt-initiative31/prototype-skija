...
public class ToolItemButtonRenderer implements ToolItemRenderer {
	...
	public enum ColorType {
		BORDER_DOWN(0.4f, ToolBarRenderer.COLOR_SELECTION_BORDER),
		BORDER_HOVER(0.2f, ToolBarRenderer.COLOR_HOVER_BORDER),
		FILL_DOWN(0.2f, ToolBarRenderer.COLOR_SELECTION_BACKGROUND),
		FILL_HOVER(0.1f, ToolBarRenderer.COLOR_HOVER_BACKGROUND);
