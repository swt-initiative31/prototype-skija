...
class DefaultScrollBarRenderer extends ScrollBarRenderer {
	...
	protected void paint(GC gc, int width, int height) {
		System.err.println("ScrollBar paint method:" + width + " " + height);
		...
		// Fill background
		gc.setBackground(scrollbar.parent.getBackground());
		gc.fillRectangle(0, 0, width, height);

		gc.setForeground(scrollbar.parent.isEnabled() ? scrollbar.parent.getForeground() : getColor(COLOR_DISABLED));
