...
public class ColorDialog extends Dialog {
	...
	private final NativeColorDialog wrappedColorDialog;
...
public ColorDialog (Shell parent) {
	this (new NativeColorDialog(Widget.checkNative(parent)));
}
...
public ColorDialog (Shell parent, int style) {
	this (new NativeColorDialog(Widget.checkNative(parent), style));
}

ColorDialog(NativeColorDialog nativeColorDialog) {
	super (nativeColorDialog);
	this.wrappedColorDialog = nativeColorDialog;
}
 ...
 */
public RGB getRGB () {
	return wrappedColorDialog.getRGB();
}
 ...
 */
public RGB[] getRGBs() {
	return wrappedColorDialog.getRGBs();
}
 ...
 */
public RGB open () {
	return wrappedColorDialog.open();
}
...
public void setRGBs(RGB[] rgbs) {
	wrappedColorDialog.setRGBs(rgbs);
}

@Override
protected NativeColorDialog getWrappedDialog() {
	return wrappedColorDialog;
}
