 ...
 * </ul>
 */
public NativeDialog (NativeShell parent) {
 ...
 */
public NativeDialog (NativeShell parent, int style) {
	checkParent (parent);
	this.parent = parent;
	this.style = style;
	title = "";
 ...
 * </ul>
 */
void checkParent (NativeShell parent) {
...
static int checkStyle (NativeShell parent, int style) {
	...
	return NativeWidget.checkBits (style, SWT.LEFT_TO_RIGHT, SWT.RIGHT_TO_LEFT, 0, 0, 0, 0);
}
