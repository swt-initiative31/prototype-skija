...
public class TableItem extends Item {
	...
	static {
		DPIZoomChangeRegistry.registerHandler(TableItem::handleDPIChange,
				TableItem.class);
	}
	...
	void paint(Event event) {
		...
		System.out.println("TableItem.paint: " + getText());
	...
	private void doPaint(Event event) {
		...
		if (topIndex > 0) {
			TableItem topNotVisibleItem = getParent().getItem(topIndex - 1);
		...
		if (getParent().selectedTableItems.contains(this)) {
			...
			gc.drawRectangle(
					new Rectangle(b.x, b.y, b.width - 1, b.height - 1));
	...
	private Point computeSize(boolean changed) {
		...
		if (text != null && !"".equals(text)) {
			GC originalGC = new GC(this.getParent());
	...
	void redraw() {
		...
		// e.index = parent.indexOf(this);
		// e.widget = this;
		//
		// super.notifyListeners(SWT.Paint, e);
	...
	public void setFont(Font font) {
		...
		// * else, Windows correctly asks you for the new string but when the
		// item
