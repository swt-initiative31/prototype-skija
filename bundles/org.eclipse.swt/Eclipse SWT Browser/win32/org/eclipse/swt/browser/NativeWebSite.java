...
abstract class NativeWebSite extends NativeOleControlSite {
	...
	*/
	...
	if (msg.message == OS.WM_KEYDOWN) {
		switch ((int)msg.wParam) {
			case OS.VK_F5:
				OleAutomation auto = new OleAutomation(this.getWrapper());
...
boolean canExecuteApplets () {
	...
	*/
	...
	if (canExecuteApplets == null) {
		WebBrowser webBrowser = (IE)((NativeBrowser)((Browser)getParent().getParent()).getWrappedWidget()).webBrowser;
...
@Override
public abstract WebSite getWrapper();
